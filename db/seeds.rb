...
Post.create(title: "Duke", featured_img: "/images/flower.jpg", content: "Vero reprehenderit est exercitationem libero laboriosam. Nihil animi voluptas est et esse voluptatem. Voluptates aut consequatur.", user_id: 7)
Post.create(title: "Fedaykin Commando", featured_img: "/images/abstract.jpg", content: "Cum quaerat accusantium. Consequatur suscipit dolore eos inventore ut. Quia fugit distinctio. Earum cumque sit at ut perferendis distinctio.", user_id: 3)
Post.create(title: "Guild Navigator", featured_img: "/images/animal.jpg", content: "Veniam et ex aliquid doloribus qui. Consequuntur aspernatur sed. Quas qui dolore placeat in. Eaque asperiores voluptatibus corrupti molestiae.", user_id: 8)
Post.create(title: "Doctor", featured_img: "/images/adventure.jpg", content: "Sint odit qui doloribus dolores. Vitae nisi qui maxime eaque neque tempora. Voluptatem similique culpa consequatur deleniti beatae ipsam.", user_id: 9)
Post.create(title: "Fish Speaker", featured_img: "/images/door.jpg", content: "Explicabo at dolorem ut sit quibusdam. Adipisci eos et facere excepturi culpa. Maxime molestiae provident at corrupti repellendus. Delectus sint rem.", user_id: 5)
Post.create(title: "Naib", featured_img: "/images/ancient.jpg", content: "Nesciunt est esse dolorem. Qui mollitia iste quibusdam ducimus facere accusantium sunt. Officiis voluptatem dolorum facere recusandae id.", user_id: 6)
Post.create(title: "Ambassador", featured_img: "/images/blue-flora.jpg", content: "Neque est incidunt ea beatae laborum ab. Nesciunt nam enim molestias. Nihil velit corrupti sed quasi consequuntur inventore sit.", user_id: 10)
Post.create(title: "Prince", featured_img: "/images/creative.jpg", content: "Earum quae porro. Maxime beatae quia. In dignissimos aut et doloribus aperiam.", user_id: 4)
Post.create(title: "Reverend Mother", featured_img: "/images/asphalt.jpg", content: "Nihil voluptas nihil sunt qui ea. Possimus facere pariatur. Impedit cupiditate distinctio voluptas voluptate sed dolorum. Sed distinctio harum velit iste amet. Ullam modi ut quos enim.", user_id: 1)
Post.create(title: "Grand Patriarch", featured_img: "/images/bloom.jpg", content: "Quisquam veniam sed eos. Dolores et sint quia ut sapiente. Est alias tempore sunt.", user_id: 2)
